...
In der psychologischen Forschung hingegen wird Stress als ein dynamischer und subjektiver Prozess aufgefasst, der über die bloße Einwirkung externer Reize hinausgeht @lazarus_stress_1984. Für die KSSB ist die Definition nach Lazarus & Folkman relevant, welche Stress als eine „Beziehung zwischen Person und Umwelt, die von der Person als ihre eigenen Ressourcen auslastend oder überschreitend und als ihr Wohlbefinden gefährdend bewertet wird” spezifiziert (Lazarus und Folkman 1984, S. 19). Folglich resultiert Stress nicht allein aus den objektiven Merkmalen einer Situation, sondern ist maßgeblich das Ergebnis individueller Bewertungs- und Bewältigungsprozesse.
...
Effektive Bewältigungsmechanismen können jedoch die schädlichen Auswirkungen von Stressoren signifikant abmildern. Ob ein Stressor tatsächlich zu negativen Outcomes führt, wird zudem durch verschiedene Moderatoren beeinflusst. Der Stress-Buffering-Effekt besagt, dass soziale Unterstützung den negativen Zusammenhang zwischen Stress und Outcomes abschwächt (Cohen & Wills, 1985).So zeigen Personen mit einem stabilen sozialen Rückhalt unter Belastung geringere endokrine und psychische Stressreaktionen. Dennoch ist anzumerken, dass selbst hochgradig adaptive Strategien bei intensiven oder chronischen Belastungen an ihre Grenzen stoßen können, da sich physiologische und emotionale Schäden kumulieren können.

Neben sozialen Faktoren dienen psychologische Ressourcen wie persönlicher Optimismus und eine hohe Selbstwirksamkeitserwartung als Puffer. Diese Ressourcen bestimmen nach der Theory of Conservation of Resources (COR; Hobfoll, 1989) nicht nur die Widerstandsfähigkeit gegenüber Verlusten, sondern beeinflussen auch maßgeblich, ob eine Person im Vorfeld adaptive Coping-Strategien wählt oder in maladaptive Muster verfällt.
...
Stress sollte jedoch nicht unabhähgig von Coping betrachtet werden, da die beiden Konstrukte sich wechselseitig beeinflussen. Aus diesem Grund sollten beiden Konstrukte auch gemeinsam erfasst werden.
...
Abbildung 3 zeigt ein Korrelationsnetzwerk, das die Zusammenhänge zwischen allen KSSB-Skalen und den Validierungskriterien visualisiert.
#figure(
  image("plots/Korrelationsmap_Theorie_gemischt.png", width: 100%), caption: [Theoretisch erwartetes Korrelationsmuster der Stressskalen und der Validitätskriterien. Alle Korrelationen sind der Erwartung nach vom Betrag her ca. zwischen 0,4 und 0,7.]
)
#figure(
  image("plots/Korrelationsmap_Empirie_gemischt.png"),
  caption: [Empirisch beobachtetes Korrelationsmuster der Stressskalen und der Validitätskriterien. Alle Korrelationen sind vom Betrag her zwischen 0,4 und 0,7.]
)
...
Die Composite Reliability ist etwas niedriger als im SCI, wo CR = .82 (Stressbelastung)  und CR = .86 (Stresssymptome) ist. Trotzdem ist die CR der Kurzskala gut bis sehr gut und für eine Kurzskala völlig ausreichend. Der Modellfit ist sehr viel schlechter als im SCI, allerdings war unsere Stichprobe auch zu klein, um eine reliable CFA durchzuführen. Die guten Faktorladungen suggerieren, dass mit einer größeren Stichprobe wahrscheinlich ein besserer Fit gefunden worden wäre.
